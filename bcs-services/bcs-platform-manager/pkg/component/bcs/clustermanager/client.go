...
// Options for cluster manager client
type Options struct {
	Target string
	Token  string
}
...
// SetClusterManagerClient set project manager client
func SetClusterManagerClient(o Options) {
	options = o
}

// NewClusterManagerClient create client for bcs-Cluster
func NewClusterManagerClient(ctx context.Context) (*Client, error) {
