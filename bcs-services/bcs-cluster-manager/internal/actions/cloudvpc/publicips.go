...
// GetCloudPublicIPsAction action for list cloud bwps
type GetCloudPublicIPsAction struct {
	ctx   context.Context
	...
	req  *cmproto.GetCloudPublicIPsRequest
	resp *cmproto.GetCloudPublicIPsResponse
	ips  []*cmproto.PublicIPInfo
}

// NewGGetCloudPublicIPsAction create list action for cloud bwps
func NewGGetCloudPublicIPsAction(model store.ClusterManagerModel) *GetCloudPublicIPsAction {
	return &GetCloudPublicIPsAction{
		model: model,
	}
}

func (ga *GetCloudPublicIPsAction) getCloudBwpsResource() error {
	...
	ga.ips, err = vpcMgr.ListPublicIP(cmOption)
	if err != nil {
		return err
	}
...
func (ga *GetCloudPublicIPsAction) setResp(code uint32, msg string) {
	ga.resp.Code = code
	ga.resp.Message = msg
...
func (ga *GetCloudPublicIPsAction) validate() error {
	err := ga.req.Validate()
	if err != nil {
		return err
	}
...
func (ga *GetCloudPublicIPsAction) getRelativeData() error {
...
func (ga *GetCloudPublicIPsAction) Handle(
	ctx context.Context, req *cmproto.GetCloudPublicIPsRequest, resp *cmproto.GetCloudPublicIPsResponse) {
	if req == nil || resp == nil {
